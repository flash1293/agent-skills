...
| 9.4     | May 2026 | GA           | TS/TBUCKET GA, time series funcs GA, WITHOUT/METRICS_INFO/TS_INFO, PROMQL (preview), Views, RERANK GA, MV_EXPAND/VALUES GA, SET time_zone |
...
- Use `SET approximation = true` for faster `COUNT_DISTINCT` on large datasets when exact counts aren't needed
